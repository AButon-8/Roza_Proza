...
```{r}
# Находим все имена собственные в тексте
...
persona_qty <- all_roza_ann_tbl |> 
  filter(lemma == "Роза" | lemma == "Клара" | lemma == "Ниуниу" 
         ...
         | lemma == "Либкнехта" | lemma == "Парвус" | lemma == "сон"
         ...
         | lemma == "Максим" | lemma == "**Парвус" | token == "Мими" 
         | lemma == "Юю") |> 
  select(doc_id, lemma, token, upos, feats, link) |>
